...
import com.ably.realtime_betting.receivers.AblyPushMessagingService;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initAblyRuntime() throws AblyException {
        ...
        options.key = "1K261w.mHzTXQ:ze0jubYsDa8ftyTTnFcpgGSL1O399hwMvsQ-67Kte24";
    ...
    public void moveToBettingView(View view) {
